...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : kill_driver_input_Pin kill_left_input_Pin inertia_input_Pin overtravel_input_Pin */
  GPIO_InitStruct.Pin = kill_driver_input_Pin|kill_left_input_Pin|inertia_input_Pin|overtravel_input_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : ts_input_Pin */
  GPIO_InitStruct.Pin = ts_input_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ts_input_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : ts_input_new_Pin */
  GPIO_InitStruct.Pin = ts_input_new_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ts_input_new_GPIO_Port, &GPIO_InitStruct);
...
void StartDefaultTask(void *argument)
{
  ...
  /* USER CODE BEGIN 5 */
	...
	for (;;) {
		...
		adc[2] = adc_data[Analog_channel::BRAKE_BACK];
		...
		can_acceleraton_frame_send((int16_t) acc[0], (int16_t) acc[1],
				(int16_t) acc[2]);
		can_gyroscope_frame_send((int16_t) gyr[0], (int16_t) gyr[1],
				(int16_t) gyr[2]);
