...
const osThreadAttr_t blink01_attributes = { .name = "blink01", .cb_mem =
		&blink01ControlBlock, .cb_size = sizeof(blink01ControlBlock),
		.stack_mem = &blink01Buffer[0], .stack_size = sizeof(blink01Buffer),
...
static void MX_GPIO_Init(void) {
	...
	/*Configure GPIO pins : kill_driver_input_Pin kill_right_input_Pin kill_left_input_Pin inertia_input_Pin
	 overtravel_input_Pin */
	GPIO_InitStruct.Pin = kill_driver_input_Pin | kill_right_input_Pin
			| kill_left_input_Pin | inertia_input_Pin | overtravel_input_Pin;
